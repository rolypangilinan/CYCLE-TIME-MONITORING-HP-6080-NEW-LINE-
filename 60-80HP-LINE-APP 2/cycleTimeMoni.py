...
def complete_kitting():
    ...
    try:
        ...
        if result:
            # Save each row to its designated material-specific table (tbl_frame_zam, tbl_frame_lead, etc.)
            db_manager.save_to_material_tables(kitting_no, job_order, model_code, materials, kitting_qr_code)
