...
def submit_material_data():
    """Submit material data for a job order"""
    try:
        data = request.json
        ...
        print(f"Material Data Submitted: JO={job_order}, Model={model_code}, Qty={quantity}, Materials={len(materials)}")
